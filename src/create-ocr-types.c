...
void createOcrTypes()
{
  ...
  fprintf(f, "!\n\n");
  /* fprintf(f, "#DEFINE TYPE(ocrGuid_t) type(C_INTPTR_T)\n"); */
  ...
  /* fprintf(f, "type, bind(C) :: ocrGuid_t\n"); */
  /* fprintf(f, "  integer(C_INTPTR_T)\n"); */
  /* fprintf(f, "end type ocrGuid_t\n\n"); */
  ...
  fprintf(f, "integer, parameter :: u64 = C_INT64_T\n");
  fprintf(f, "integer, parameter :: s64 = C_INT64_T\n");
  fprintf(f, "integer, parameter :: u32 = C_INT32_T\n");
  fprintf(f, "integer, parameter :: s32 = C_INT32_T\n");
  fprintf(f, "integer, parameter :: u16 = C_INT16_T\n");
  fprintf(f, "integer, parameter :: s16 = C_INT16_T\n");
  fprintf(f, "integer, parameter :: u8 = C_INT8_T\n");
  fprintf(f, "integer, parameter :: s8 = C_INT8_T\n");
  

  fprintf(f, "integer(ocrGuid_k), parameter :: NULL_GUID = 0\n");
  fprintf(f, "integer(ocrGuid_k), parameter :: NULL_GUID_ARRAY(1) = 0\n");
  /* fprintf(f, "integer(C_INTPTR_T), dimension(1), parameter :: C_NULL_ARRAY = %i\n", 0); */
  fprintf(f, "integer(u64), parameter :: C_NULL = %i\n", 
	  0);
